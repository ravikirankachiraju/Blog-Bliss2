...
const ProfilePage = () => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        const response = await axios.get("https://blogbliss-9l89.onrender.com/profile", {
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      const response = await axios.put("https://blogbliss-9l89.onrender.com/profile", formData, {
        headers: {
          "auth-token": token,
