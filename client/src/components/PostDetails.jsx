...
const PostDetails = () => {
  ...
  useEffect(() => {
    const fetchPost = async () => {
      try {
        ...
        const response = await axios.get(`https://blogbliss-9l89.onrender.com/posts/${postId}`);
  ...
  const OnDelete = async () => {
    try {
      await axios.delete(`https://blogbliss-9l89.onrender.com/posts/${postId}`);
  ...
  const handleAddComment = async (commentText) => {
    ...
    try {
      ...
      const response = await axios.post(`https://blogbliss-9l89.onrender.com/posts/comments/${postId}`,
        { text: commentText },
  ...
  const handleDeleteComment = async (commentId) => {
    try {
      ...
      await axios.delete(`https://blogbliss-9l89.onrender.com/posts/comments/${commentId}`, {
        headers: { 'auth-token': token }
      });
  ...
  const handleLike = async () => {
    try {
      ...
      const response = await axios.post(`https://blogbliss-9l89.onrender.com/posts/like/${postId}`,
        {},
        { headers: { 'auth-token': token } }
      );
